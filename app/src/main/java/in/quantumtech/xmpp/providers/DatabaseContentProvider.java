package in.quantumtech.xmpp.providers;
...
public class DatabaseContentProvider extends ContentProvider {
    ...
    private static final int GROUP_OPERATION = 9;
    ...
    public DatabaseContentProvider() {
        ...
        uriMatcher.addURI(AUTHORITY, ChatContract.GroupTable.TABLE_NAME, GROUP_OPERATION);
    }
    ...
    public Cursor query(Uri uri, String[] projection, String selection,
        ...
        } else if (code == GROUP_OPERATION) {
            table = ChatContract.GroupTable.TABLE_NAME;
        } else {
    ...
    public String getType(Uri uri) {
        switch (uriMatcher.match(uri)) {
            ...
            case GROUP_OPERATION:
                return ChatContract.GroupTable.CONTENT_ITEM_TYPE;
            default:
                throw new IllegalArgumentException("Unknown URI " + uri);
        }
    }
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        switch (uriMatcher.match(uri)) {
            ...
            case GROUP_OPERATION:
                table = ChatContract.GroupTable.TABLE_NAME;
                contentUri = ChatContract.GroupTable.CONTENT_URI;
                break;
