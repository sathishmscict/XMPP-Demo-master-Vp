	...
	public static MessageView newView(int type, Context context) {
		...
		switch (type) {
			...
			case ChatMessageTableHelper.TYPE_OUTGOING_IMAGE:
				...
				break;
			case ChatMessageTableHelper.TYPE_INCOMING_VIDEO:
				view = new IncomingImageMessageView(context);
				break;
			case ChatMessageTableHelper.TYPE_OUTGOING_VIDEO:
				view = new OutgoingImageMessageView(context);
				break;
			case ChatMessageTableHelper.TYPE_GROUP_MESSAGE:
				view = new OutgoingPlainTextView(context);
				TextView message1 = (TextView) view.findViewById(R.id.tv_message);
				if (message1 != null){
			...
			case ChatMessageTableHelper.TYPE_OUTGOING_LOCATION:
				...
				((LocationView)view).initializeMapView();
				break;
			case ChatMessageTableHelper.TYPE_GROUP_ACTIVITY:
				view = new GroupActivityView(context);
				break;
		}
